...
\hspace{-1em} Machine learning softwares & TensorFlow, PyTorch, Spark, Matlab, Caffe, GraphLab\\
...
\item Works patented and published at \emph{ICRA '19}, \emph{NeurIPS '18 MLITS Workshop}, and \emph{NeurIPS '19 ``ML for Autonomous Driving'' Workshop}.
\end{rSubsection}
\end{rSection}
\vspace{-.15in}
...
\hspace{-1em} \textbf{Program Committee}: \emph{NeurIPS ``Machine Learning for Autonomous Driving'' Workshop, CVPR ``Precognition: Seeing through the Future'' Workshop, ACM Symposium on Cloud Computing '17 and '18, Computing Conference '17}

\hspace{-1em} \textbf{Reviewer}: \emph{IEEE International Conference on Robotics and Automation '19, IEEE Robotics and Automation Letters '19, IEEE Big Data '19, Cluster Computing '19, IEEE Transactions on Network Science and Engineering '18}
