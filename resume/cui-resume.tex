...
\hspace{-1em} Languages/Libraries/Tools & Python, C/C$+$$+$, PyTorch, TensorFlow, git, LaTex, JIRA\\
\end{tabular}
\end{rSection}
% \vspace{-.05in}
...
\item Lead a team of 7 people. Build R\&D team, make plan and strategy, and manage risk.
