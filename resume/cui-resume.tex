...
\vspace{-.2in}
\item[] Technical leader with strong technical background and 7 years of industry experience in auotonomous driving.
...
\item I lead Motional's Behavior Prediction team.
\item My team owns the behavior prediction model for Motional's self-driving car. The model uses transformer and graph attention architectures to predict the future behaviors of the other road users around AV.
