...
\vspace{-.2in}
\item[] Autonomous driving, deep learning, computer vision, robotics.
...
\hspace{-1em} Languages/Libraries/Tools & Python, C/C$+$$+$, PyTorch, git, JIRA, TensorFlow, LaTex\\
\end{tabular}
\end{rSection}
% \vspace{-.05in}
...
% \vspace{-0.3em}
\item[] \hspace{-2em} {\bf Principal Engineer, Prediction Team Lead} \hfill January, 2021 to \emph{now}
\item Build and managing a team of 9 people.
\item My team developed and owns the trajectory prediction module that predicts the future trajectories of the other agents on the road for Motional's self-driving car.
